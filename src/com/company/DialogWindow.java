        ...
        private void addMessageListeners()
        {
            btnMessage1.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent e) {
                    JOptionPane.showMessageDialog(DialogWindow.this,
            ...
            btnConfirm1.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent e) {
                    ...
                    if (result == JOptionPane.YES_OPTION)
                        JOptionPane.showConfirmDialog(DialogWindow.this,
                                "Вы не отказываетесь?");
        ...
        private void addInputListeners()
        {
            btnInput1.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent e) {
                    ...
                    JOptionPane.showInputDialog(DialogWindow.this,
                            "Вы ответили", result);
                }
            });
            ...
            btnInput3.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent e) {
                    ...
                    JOptionPane.showMessageDialog(DialogWindow.this, result);
                }
            });
        }
    }
